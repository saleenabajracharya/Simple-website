...
closeMenu.addEventListener("click",function(){
    menubar.style.transform = "transform(-100%)"
})
    ...
    displayProducts(products){
        ...
        products.forEach(product=>{
            ...
            productDiv.innerHTML = `<div class = "product-card"> 
                                    <img src="${product.iamge}" alt="product">
                                    <span class="add-to-cart" data-id="${product.id}">
                                    <i class ="fa fa-cart--plus fa-1x" style="margin-right:0.1em;"></i>
                                    Add to Cart
                                    </span>
                                ...
                                cartContent.addEventListener("click",(event)=>
                                {
                                    if(event.target.classList.contains("cart-product-remove")){
                                        ...
                                        if(item.amount>1){
                                            ...
                                            Storage.saveCart(Cart)
                                            this.setCartValues(Cart)
                                            event.target.previoudElementSibiling.innerHTML = item.amount
                                        }
                                        else{
                                            this.removeItem(id)
                                            let div = event.target.parentElement.parentElement.parentElement.parentElement
                                        ...
                                        btn.addEventListener("click",(event)=>{
                                            ...
                                            if(item.id===id){
                                                ...
                                                if(item.amount>0){
                                                    ...
                                                    eventcurrentTarget.parentElement.parentElement.parentElement.removeChild(event.currentTarget.parentElement.parentElement)
                                                     this.removeItem(id)
                                                }
                                            }
                                        })
